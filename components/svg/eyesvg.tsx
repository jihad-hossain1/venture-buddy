...
// Define the type for the component props explicitly
type EyeSVGProps = React.SVGProps<SVGSVGElement>

const EyeSVG: React.FC<EyeSVGProps> = (props) => {
    // Destructure the props to separate SVG-specific props and custom props
    const { fill, stroke, ...svgProps } = props;
    ...
    return (
        <svg
            ...
            {...svgProps} // Spread SVG-specific props onto the svg element
        >
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                ...
                fill={fill || "#000000"} // Apply custom props or default to black
                stroke={stroke} // Apply custom stroke if provided
            />
            <path
