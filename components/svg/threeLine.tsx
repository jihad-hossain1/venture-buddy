...
const ThreeLine: React.FC<SvgComponentProps> = (props) => {
  // Destructure svg-specific props to prevent spreading them into the <path> elements
  ...
  return (
    <svg
      ...
      {...svgProps} // Spread only svg-specific props here
    >
      <path
