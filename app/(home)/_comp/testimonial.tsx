...
const TestimonialCarousel: React.FC = () => {
  ...
  // Update testimonialsPerPage based on window size
  ...
  // Group testimonials into pages based on the number of items per page
            ...
            {paginatedTestimonials.map((page, pageIndex) => (
              ...
              >
                {page.map((testimonial, index) => (
                  <div
                    key={index}
                    className="testimonial-card bg-primary_light shadow-lg rounded-lg p-6 w-full md:w-1/2 lg:w-1/3 flex-shrink-0"
                  >
